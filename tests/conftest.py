...
# WARNING: Ensure imports from `pythonfastapi` comes after this line
from pythonfastapi import app, settings, db  # noqa
from pythonfastapi.cli import create_user, cli  # noqa
